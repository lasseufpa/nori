...
class NoriLteRlc : public Object // SimpleRefCount<LteRlc>
{
    ...
    friend class LteRlcSpecificLteRlcSapProvider<NoriLteRlc>;
  ...
  public:
    ...
    /**
     * @brief Sets the IMSI (International Mobile Subscriber Identity) for the RLC (Radio Link Control) entity.
     *
     * The IMSI is a unique identifier assigned to each mobile subscriber in a cellular network.
     *
 ...
 *
 */
class NoriLteRlcSm : public NoriLteRlc
{
  public:
    NoriLteRlcSm();
    ~NoriLteRlcSm() override;
    /**
     * \brief Get the type ID.
     * \return the object TypeId
     */
