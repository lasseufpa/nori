...
class NoriUeManager : public Object
{
  ...
  public:
     ...
     * The map is indexed by the DRB ID (uint8_t) and the value is a pointer to the
     * corresponding LteDataRadioBearerInfo object.
     *
...
class NoriLteEnbRrc : public Object
{
  ...
  private:
     ...
     */
    uint16_t AddUe(NoriUeManager::State state, uint8_t componentCarrierId);
