...
TypeId
NoriLteRlcUm::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::NoriLteRlcUm")
            .SetParent<NoriLteRlc>()
            .SetGroupName("Lte")
            .AddConstructor<NoriLteRlcUm>()
            .AddAttribute("MaxTxBufferSize",
                          "Maximum Size of the Transmission Buffer (in Bytes)",
                          UintegerValue(10 * 1024),
                          MakeUintegerAccessor(&NoriLteRlcUm::m_maxTxBufferSize),
                          MakeUintegerChecker<uint32_t>())
            .AddAttribute("ReorderingTimer",
                          "Value of the t-Reordering timer (See section 7.3 of 3GPP TS 36.322)",
                          TimeValue(MilliSeconds(100)),
                          MakeTimeAccessor(&NoriLteRlcUm::m_reorderingTimerValue),
                          MakeTimeChecker())
            .AddAttribute(
                ...
                BooleanValue(true),
                MakeBooleanAccessor(&NoriLteRlcUm::m_enablePdcpDiscarding),
                MakeBooleanChecker())
            .AddAttribute("DiscardTimerMs",
                          ...
                          UintegerValue(0),
                          MakeUintegerAccessor(&NoriLteRlcUm::m_discardTimerMs),
                          MakeUintegerChecker<uint32_t>());
    return tid;
}

void
NoriLteRlcUm::DoDispose()
{
    NS_LOG_FUNCTION(this);
...
void
NoriLteRlcUm::DoTransmitPdcpPdu(Ptr<Packet> p)
{
...
void
NoriLteRlcUm::DoNotifyTxOpportunity(LteMacSapUser::TxOpportunityParameters txOpParams)
{
    ...
    {
        m_rbsTimer.Cancel();
        m_rbsTimer = Simulator::Schedule(MilliSeconds(10), &NoriLteRlcUm::ExpireRbsTimer, this);
    }
}

void
NoriLteRlcUm::DoNotifyHarqDeliveryFailure()
{
    NS_LOG_FUNCTION(this);
}

void
NoriLteRlcUm::DoReceivePdu(LteMacSapUser::ReceivePduParameters rxPduParams)
{
    ...
    if (!m_reorderingTimer.IsRunning())
    {
        ...
        if (m_vrUh > m_vrUr)
        {
            ...
            m_reorderingTimer =
                Simulator::Schedule(m_reorderingTimerValue, &NoriLteRlcUm::ExpireReorderingTimer, this);
            m_vrUx = m_vrUh;
...
bool
NoriLteRlcUm::IsInsideReorderingWindow(SequenceNumber10 seqNumber)
{
...
void
NoriLteRlcUm::ReassembleAndDeliver(Ptr<Packet> packet)
{
    LteRlcHeader rlcHeader;
...
void
NoriLteRlcUm::ReassembleOutsideWindow()
{
...
void
NoriLteRlcUm::ReassembleSnInterval(SequenceNumber10 lowSeqNumber, SequenceNumber10 highSeqNumber)
{
...
void
NoriLteRlcUm::DoReportBufferStatus()
{
    Time holDelay(0);
...
void
NoriLteRlcUm::ExpireReorderingTimer()
{
