...
#ifndef NORI_RADIO_BEARER_STATS_CALCULATOR_H_
#define NORI_RADIO_BEARER_STATS_CALCULATOR_H_
...
class NoriBearerStatsCalculator : public NrBearerStatsBase
{
  public:
    /**
     * Class constructor
     */
    NoriBearerStatsCalculator();
    /**
     * Class constructor
     */
    NoriBearerStatsCalculator(std::string protocolType);
    /**
     * Class destructor
     */
    ~NoriBearerStatsCalculator() override;
