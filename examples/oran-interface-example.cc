...
//  */
// // static void
// // BuildAndSendReportMessage(E2Termination::RicSubscriptionRequest_rval_s params)
// // {
...
//  */
// // static void
// // KpmSubscriptionCallback(E2AP_PDU_t* sub_req_pdu)
// // {
...
//     //e2Term->RegisterKpmCallbackToE2Sm(200, kpmFd, &SubscriptionCallback);
