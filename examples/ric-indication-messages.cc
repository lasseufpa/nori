...
main(int argc, char* argv[])
{
    ...
    Ptr<KpmIndicationHeader> header2 =
        Create<KpmIndicationHeader>(KpmIndicationHeader::GlobalE2nodeType::gNB, headerValues2);
    Ptr<KpmIndicationHeader> header3 =
        Create<KpmIndicationHeader>(KpmIndicationHeader::GlobalE2nodeType::ng_eNB, headerValues3);
    Ptr<KpmIndicationHeader> header4 =
        Create<KpmIndicationHeader>(KpmIndicationHeader::GlobalE2nodeType::en_gNB, headerValues4);
    ...
    Ptr<MeasurementItemList> ue2DummyValues = Create<MeasurementItemList>("UE-2");
    ...
    Ptr<MeasurementItemList> ue3DummyValues = Create<MeasurementItemList>("UE-3");
    ...
    Ptr<MeasurementItemList> ue4DummyValues = Create<MeasurementItemList>("UE-4");
    ...
    Ptr<MeasResultServMo> measResultServMo = Create<MeasResultServMo>(10, measResultNr->GetValue());
